...
* [ ] Fix ra1npoc15 to build in linux
* [ ] Add the fixed ra1npoc15 payload to this
...
^^ it doesn't differ by much, with the odd unplug trick, everything worked on the older gaster.
